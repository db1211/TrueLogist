...
import {MAIN_COLOR} from "../common/sharedFunctions.js"
            ...
            <GridItem xs={12} sm={12} md={8}>
              <Card>
                <form className={classes.form}>
                    ...
                    >
                      <h4 style={{ color: colors.WHITE, fontSize:20 }}>{t("signup")}</h4>
                    </CardHeader>
                  <CardBody>
                    <GridContainer
                      spacing={2}
              ...
              <Card>
                ...
                {settings && settings.socialLogin ?
                  <CardHeader style={{
                    ...
                    <h4 style={{color:colors.WHITE, fontSize:20}}>{t('login')}</h4>
                ...
                }
                {
                 ...
                 <p  className={isRTL === "rtl" ? classes.rtlDescription : classes.ltrDescription} style={{ color: 'black', fontSize: 18,  }} >{t('country_1')} : India</p>
                 <p  className={isRTL === "rtl" ? classes.rtlDescription : classes.ltrDescription} style={{ color: 'black', fontSize: 18, }}>{t('mobile')} : 9998887777</p>
                 <p  className={isRTL === "rtl" ? classes.rtlDescription : classes.ltrDescription} style={{ color: 'black', fontSize: 18,  }}>{t('otp')} : 123456</p>
                 </div>
                 </Card>
                 :null
                }
