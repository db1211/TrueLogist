                ...
                <View style={styles.header}  >
                    {langSelection && languagedata && languagedata.langlist && languagedata.langlist.length > 1 ?
                        <View style={[styles.headLanuage, [isRTL ? { left: 20 } : { right: 20 }]]}>
                            <Text style={{ color: colors.BLACK, marginLeft: 3, fontFamily: 'Roboto-Regular' }}>{t('lang1')}</Text>
                            <RNPickerSelect
                ...
                <ScrollView style={{ width: "100%", }}>
                    <View style={{ width: '100%', height: '100%', alignItems: 'center', flex: 1, }}  >
                        ...
                        {isNaN(state.contact) || (settings.emailLogin && !settings.mobileLogin) ?
                            <View style={[styles.box2, { flexDirection: isRTL ? 'row-reverse' : 'row', alignItems: 'center' }]}>
                                <TextInput
                                    style={[styles.textInput1, { textAlign: isRTL ? "right" : "left" }]}
                                    ...
                                    placeholderTextColor={colors.MAP_TEXT}
                                />
                                 <View style={[styles.hideButton,{height: 40, width: 40}]} >
                                    <TouchableOpacity onPress={() => setEyePass(!eyePass)} style={{height: 40, width: 40, alignItems: isRTL ? 'flex-start' : 'flex-end', justifyContent: 'center'}} >
                                        <Feather name={eyePass ? "eye-off" : "eye"} size={20} color={colors.HEADER} />
                                    </TouchableOpacity>
                                </View>
                            </View>
                            : null}
                        {state.verificationId ? null :
                            <View style={[styles.box2]}>
                                <Button
                                    ...
                                    title={isNaN(state.contact) ? t('signIn') : t('request_otp')}
                                    activeOpacity={0.8}
